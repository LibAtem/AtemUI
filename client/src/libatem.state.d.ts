declare module LibAtem {
  ...
  export interface MixEffectState_KeyerDVEState {
    ...
    borderOuterSoftness: uint
    borderInnerSoftness: uint
    borderBevelSoftness: uint
    borderBevelPosition: uint
    borderOpacity: uint
    borderHue: number
    borderSaturation: number
    borderLuma: number
    lightSourceDirection: number
    lightSourceAltitude: uint
    maskEnabled: boolean
    maskTop: number
    maskBottom: number
    maskLeft: number
  ...
  // ../LibAtem/LibAtem.State/Tolerance/ToleranceAttribute.cs
  export interface ToleranceAttribute extends Attribute, IEqualityComparer<double> {
    tolerance: number
  }

  // ../LibAtem/LibAtem.State/Tolerance/ToleranceAttribute.cs
  export interface UintToleranceAttribute extends Attribute {
    tolerance: uint
  }

  // ../LibAtem/LibAtem.State/Tolerance/ToleranceAttribute.cs
  export interface DecibelToleranceAttribute extends ToleranceAttribute {}
  ...
  export interface KeyIndexAttribute extends Attribute {
    index: UpstreamKeyId
  }
  ...
  // ../LibAtem/LibAtem/Common/VideoSource.cs
  export interface VideoSourceTypeAttribute extends Attribute {
  ...
  // ../LibAtem/LibAtem/Common/VideoSource.cs
  export interface VideoSourceDefaultsAttribute extends Attribute {
    longName: string
    shortName: string
  }

  // ../LibAtem/LibAtem/Common/VideoSource.cs
  export interface VideoSourceAvailabilityAttribute extends Attribute {
  ...
  export interface VideoModeRateAttribute extends Attribute {
    rate: number
  }

  // ../LibAtem/LibAtem/Common/VideoMode.cs
  export interface VideoModeStandardAttribute extends Attribute {
    standard: VideoModeStandard
  }

  // ../LibAtem/LibAtem/Common/VideoMode.cs
  export interface VideoModeMultiviewerModeAttribute extends Attribute {
    mode: VideoMode
    modeNon3G: VideoMode
  }

  // ../LibAtem/LibAtem/Common/VideoMode.cs
  export interface VideoModeResolutionAttribute extends Attribute {
    resolution: VideoModeResolution
  }

  // ../LibAtem/LibAtem/Common/VideoMode.cs
  export interface SizeAttribute extends Attribute {
    width: uint
    height: uint
  ...
  export interface XmlAsStringAttribute extends Attribute {}
  ...
  export interface AudioSourceTypeAttribute extends Attribute {
    type: AudioSourceType
  }

  // ../LibAtem/LibAtem/Common/AudioSource.cs
  export interface AudioPortTypeAttribute extends Attribute {
