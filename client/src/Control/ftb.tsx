      ...
      <div className="box-ftb">
        <div className="rate">
          ...
          <RateInput
            ...
            callback={e => {
              props.sendCommand('LibAtem.Commands.MixEffects.FadeToBlackRateSetCommand', {
                Index: props.meIndex,
                Rate: e
              })
            }}
        ...
        <AtemButtonGeneric
          color="red"
          callback={() =>
            props.sendCommand('LibAtem.Commands.MixEffects.FadeToBlackAutoCommand', { Index: props.meIndex })
          }
          name={'FTB'}
