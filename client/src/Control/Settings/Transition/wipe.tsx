      ...
      <div>
        ...
        <div className="ss-row" style={{ marginTop: '20px', marginBottom: '20px' }}>
          ...
          <div className="ss-rate">
            <RateInput
              ...
              value={this.props.currentState.mixEffects[this.props.mixEffect].transition.wipe.rate}
              callback={(e: number) =>
                this.sendCommand('LibAtem.Commands.MixEffects.Transition.TransitionWipeSetCommand', {
                  Index: this.props.mixEffect,
                  Mask: 1,
        ...
        <div className="ss-slider-holder">
          <div className={patterns[pattern].symmetry ? 'sss ss-slider-outer' : 'sss ss-slider-outer disabled'}>
            <Slider
              ...
              value={this.props.currentState.mixEffects[this.props.mixEffect].transition.wipe.symmetry}
            />
        ...
        <div className="ss-row xy">
          ...
          <MagicInput
            ...
            value={this.props.currentState.mixEffects[this.props.mixEffect].transition.wipe.xPosition}
            callback={(value: any) => {
              if (value != '') {
                this.sendCommand('LibAtem.Commands.MixEffects.Transition.TransitionWipeSetCommand', {
                  Index: this.props.mixEffect,
          ...
          <MagicInput
            ...
            value={this.props.currentState.mixEffects[this.props.mixEffect].transition.wipe.yPosition}
            callback={(value: any) => {
              if (value != '') {
                this.sendCommand('LibAtem.Commands.MixEffects.Transition.TransitionWipeSetCommand', {
                  Index: this.props.mixEffect,
        ...
        <div className="ss-row" style={{ gridTemplateColumns: '1fr 1fr 1.5fr' }}>
          ...
          <label className="ss-checkbox-container">
            ...
            <input
              type="checkbox"
              checked={this.props.currentState.mixEffects[this.props.mixEffect].transition.wipe.flipFlop}
              onClick={() =>
                this.sendCommand('LibAtem.Commands.MixEffects.Transition.TransitionWipeSetCommand', {
                  Index: this.props.mixEffect,
                  FlipFlop: !this.props.currentState.mixEffects[this.props.mixEffect].transition.wipe.flipFlop,
                  Mask: 512
                })
              }
            ></input>
        ...
        <div className="ss-slider-holder">
          <div className={diabledClass}>
            <Slider
              ...
              value={this.props.currentState.mixEffects[this.props.mixEffect].transition.wipe.borderSoftness}
            />
        ...
        <div className="ss-slider-holder">
          <div className={diabledClass}>
            <Slider
              ...
              value={this.props.currentState.mixEffects[this.props.mixEffect].transition.wipe.borderWidth}
            />
        ...
        <div className="ss-row">
          <div
            className={
              this.props.currentState.mixEffects[this.props.mixEffect].transition.wipe.borderWidth === 0
                ? 'ss-label disabled'
                : 'ss-label'
            }
          >
          ...
          <select
            disabled={this.props.currentState.mixEffects[this.props.mixEffect].transition.wipe.borderWidth === 0}
            onChange={e => {
              this.sendCommand('LibAtem.Commands.MixEffects.Transition.TransitionWipeSetCommand', {
                Index: this.props.mixEffect,
                Mask: 8,
                BorderInput: e.currentTarget.value
              })
            }}
            value={this.props.currentState.mixEffects[this.props.mixEffect].transition.wipe.borderInput}
