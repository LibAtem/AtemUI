        ...
        if (this.state.page === 0) { //mix
            box.push(
                <div className="ss-row"><div className="ss-label">Rate:</div> <div className="ss-rate">
                    <RateInput value={this.props.currentState.mixEffects[this.props.mixEffect].transition.mix.rate} videoMode={this.props.currentState.settings.videoMode}
                        callback={(e: string) => { this.sendCommand("LibAtem.Commands.MixEffects.Transition.TransitionMixSetCommand", { Index: this.props.mixEffect, Rate: e }) }} />
                </div>
                </div>
            ...
            box.push(
                <div className="ss-row"><div className="ss-label">Rate:</div> <div className="ss-rate">
                    <RateInput value={this.props.currentState.mixEffects[this.props.mixEffect].transition.dip.rate} videoMode={this.props.currentState.settings.videoMode}
                        callback={(e: string) => { this.sendCommand("LibAtem.Commands.MixEffects.Transition.TransitionDipSetCommand", { Index: this.props.mixEffect, Mask: 1, Rate: e }) }} />
                </div>
                </div>
            ...
            box.push(<div className="ss-row">
                ...
                <select onChange={(e) => { this.sendCommand("LibAtem.Commands.MixEffects.Transition.TransitionDipSetCommand", { Index: this.props.mixEffect, Mask: 2, Input: e.currentTarget.value }) }} value={this.props.currentState.mixEffects[this.props.mixEffect].transition.dip.input} className="ss-dropdown" id="cars">
                    {this.getSourceOptions()}
                </select>
            </div>)
        }else if(this.state.page === 2){//wipe
            box.push(<Wipe mixEffect={this.props.mixEffect} device={this.props.device} signalR={this.props.signalR} currentState={this.props.currentState} />)

        } else if (this.state.page === 3) { //stinger
            box.push(<div className="ss-row">
                <div className="ss-label">Source:</div>
                <select onChange={(e) => { this.sendCommand("LibAtem.Commands.MixEffects.Transition.TransitionStingerSetCommand", { Index: this.props.mixEffect, Mask: 1, Source: e.currentTarget.value }) }} value={this.props.currentState.mixEffects[this.props.mixEffect].transition.stinger.source} className="ss-dropdown" id="cars">
            ...
            box.push(
                <div className="ss-row"><div className="ss-label">Clip Duration:</div> <div className="ss-rate">
                    <RateInput value={this.props.currentState.mixEffects[this.props.mixEffect].transition.stinger.clipDuration} videoMode={this.props.currentState.settings.videoMode}
                        callback={(e: string) => { this.sendCommand("LibAtem.Commands.MixEffects.Transition.TransitionStingerSetCommand", { Index: this.props.mixEffect, Mask: 64, ClipDuration: e }) }} />
                </div>
                </div>
            ...
            box.push(
                <div className="ss-row"><div className="ss-label">Trigger Point:</div> <div className="ss-rate">
                    <RateInput value={this.props.currentState.mixEffects[this.props.mixEffect].transition.stinger.triggerPoint} videoMode={this.props.currentState.settings.videoMode}
                        callback={(e: string) => { this.sendCommand("LibAtem.Commands.MixEffects.Transition.TransitionStingerSetCommand", { Index: this.props.mixEffect, Mask: 128, TriggerPoint: e }) }} />
                </div>
                </div>
            ...
            box.push(
                <div className="ss-row"><div className="ss-label">Mix Rate:</div> <div className="ss-rate">
                    <RateInput value={this.props.currentState.mixEffects[this.props.mixEffect].transition.stinger.mixRate} videoMode={this.props.currentState.settings.videoMode}
                        callback={(e: string) => { this.sendCommand("LibAtem.Commands.MixEffects.Transition.TransitionStingerSetCommand", { Index: this.props.mixEffect, Mask: 256, MixRate: e }) }} />
                </div>
                </div>
            ...
            box.push(
                <div className="ss-row"><div className="ss-label">Pre Roll:</div> <div className="ss-rate">
                    <RateInput value={this.props.currentState.mixEffects[this.props.mixEffect].transition.stinger.preroll} videoMode={this.props.currentState.settings.videoMode}
                        callback={(e: string) => { this.sendCommand("LibAtem.Commands.MixEffects.Transition.TransitionStingerSetCommand", { Index: this.props.mixEffect, Mask: 32, Preroll: e }) }} />
                </div>
                </div>

            )
            box.push(this.getPreMultBox(this.props.mixEffect))
        }else if(this.state.page === 4){//dve
            box.push(<DVE mixEffect={this.props.mixEffect} device={this.props.device} signalR={this.props.signalR} currentState={this.props.currentState} />)
